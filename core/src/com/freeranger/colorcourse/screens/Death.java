...
public class Death implements Screen {
	...
	public Death(final Main game) {
		...
		atlas = new TextureAtlas("data/menu/death/button.pack");
		skin = new Skin(atlas);
		...
		if(lang.getLanguage() == 1)titleTexture = new Texture(Gdx.files.internal("data/menu/death/title_german.png"));
		else if(lang.getLanguage() == 3)titleTexture = new Texture(Gdx.files.internal("data/menu/death/title_swedish.png"));
		else if(lang.getLanguage() == 2)titleTexture = new Texture(Gdx.files.internal("data/menu/death/title_spanish.png"));
		else if(lang.getLanguage() == 0)titleTexture = new Texture(Gdx.files.internal("data/menu/death/title_english.png"));
	...
	public void render(float delta) {
		if(show){
			Gdx.gl.glClearColor(18f / 255f, 44f / 255f, 87f / 255f, 1);
