...
public class GameCompleted implements Screen {

	// TODO: Change title from "Level Complete!" etc. to "Game Completed!" etc.
	...
	public GameCompleted(final Main game) {
		show = true;
		this.game = game;
		...
		atlas = new TextureAtlas("data/menu/gamecompleted/button.pack");
		skin = new Skin(atlas);
		...
		if(lang.getLanguage() == 1)titleTexture = new Texture(Gdx.files.internal("data/menu/gamecompleted/title_german.png"));
		else if(lang.getLanguage() == 3)titleTexture = new Texture(Gdx.files.internal("data/menu/gamecompleted/title_swedish.png"));
		else if(lang.getLanguage() == 2)titleTexture = new Texture(Gdx.files.internal("data/menu/gamecompleted/title_spanish.png"));
		else if(lang.getLanguage() == 0)titleTexture = new Texture(Gdx.files.internal("data/menu/gamecompleted/title_english.png"));
		else titleTexture = new Texture(Gdx.files.internal("data/menu/gamecompleted/title_english.png"));
		...
		if(lang.getLanguage() == 1 || lang.getLanguage() == 3){
		...
		text = new Label(lang.getText().get("FinalLabel"), textStyle);
		//layout
		table.setY(30);
		table.add(title);
		//table.getCell(title).space(15);
		table.row();
		table.add(text);
		//table.getCell(text).space(25);
		table.row();
	...
	public void switchScreen(String screen){
		if(screen == "playagain" && canifade){
			game.level = 20;
			game.setScreenWithFade(new Play(game, 48 / B2DVars.PPM, 948 / B2DVars.PPM, 1, "no", 0), 2.4f);
	    	canifade = false;
