...
public class YellowMovingBlock {
	...
	public YellowMovingBlock(Body body, Main game, Play play, int direction, int minPos, int maxPos, float velocity, int timerLength) {
		this.body = body;
		this.game = game;
		this.play = play;
